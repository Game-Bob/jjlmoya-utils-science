...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: 'Изменяйте солнечный поток, начальное покрытие льдом и альбедо поверхности, чтобы увидеть, как система приближается к устойчивому тёплому или холодному состоянию. Это упрощённая учебная модель без океанических течений и региональных различий, поэтому её результаты помогают сравнивать механизмы, но не заменяют климатический прогноз.',
    },
    {
      type: 'paragraph',
