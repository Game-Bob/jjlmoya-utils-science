...
export const content: NaturalSelectionLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: '请比较多次独立运行，观察相同趋势是否会重复出现。' },
    { type: 'paragraph', html: '记录每一代的频率，可以把可见变化与随机抽样联系起来，并比较不同初始条件。' },
    { type: 'paragraph', html: '不同初始条件可能产生不同的短期结果，因此应结合多次运行观察长期趋势。' },
    { type: 'paragraph', html: '通过记录每一代的频率，可以把可见的变化与随机抽样联系起来。' },
  ],
  faq,
  bibliography,
  howTo,
