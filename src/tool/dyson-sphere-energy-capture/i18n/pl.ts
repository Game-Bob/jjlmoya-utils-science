...
const faq = [
  ...
  },
  {
    ...
    answer: 'Szacuje odleglosc, w ktorej kolektory promieniujace z obu stron osiagaja wybrana temperature robocza przy wybranej jasnosci gwiazdowej. Gorątsze kolektory moga orbitowac blizej, podczas gdy chlodniejsze kolektory wymagają wiekszych promieni.',
  },
  {
  ...
  {
    question: 'Dlaczego jasne gwiazdy wymagają tak duzych systemów kolektorów?',
  ...
  },
  {
    ...
    answer: 'Tak, jesli gwiazda macierzysta jest wystarczająco jasna, a kolektory wydajne. Wokol gwiazdy podobnej do Słonca, osiagniecie blisko Typu II wymaga przechwycenia duzej frakcji jasnosci słonecznej, ale wokol jajniejszych gwiazd ten sam cel mocy moze wymagac nizszej frakcji pokrycia.',
  },
];
