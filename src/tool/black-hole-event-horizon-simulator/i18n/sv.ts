...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Det här avsnittet beskriver geometrin som används av simuleringen mer noggrant. Schwarzschildradien växer med massan och är i den ideala Schwarzschildlösningen en koordinatyta som hör samman med händelsehorisonten. Fotonssfären ligger längre ut och motsvarar instabila cirkulära ljusbanor: en liten störning kan ändra ljusets fortsatta bana kraftigt. Den visade tidsdilatationen beror på vilken observatör som jämför klockorna och ska inte blandas ihop med egen tid för en lokal klocka. Ändra massa och avstånd var för sig för att jämföra skalor utan att blanda effekterna. Modellen tar inte med rotation, elektrisk laddning, omgivande materia, ackretionsskiva, magnetfält, strålning eller tidvattenkrafter hos ett konkret objekt. Den ska bygga intuition om allmän relativitet och skilja en matematisk definition från en astronomisk observation. En verklig källa kräver data om massa, rotation, miljö och bana samt jämförelse med en publicerad metod. Sidan ger ingen operativ prognos eller instruktion för att närma sig ett kompakt objekt. Skriv ned antagandena och jämför en parameter i taget.' },
    { type: 'paragraph', html: 'Du kan också ändra observatörens position och jämföra hur tidsvisningen förändras. Exemplet hjälper till att skilja en koordinatbeskrivning från en lokal klockas mätning. I ett verkligt objekt påverkar rotation och omgivande materia ljusets banor och den observerade signalen; en enkel sfäriskt symmetrisk modell kan därför inte beskriva alla observationer. Skriv ned varje parameter och upprepa beräkningen under samma villkor för att förstå resultatets ursprung och begränsningar.' },
    { type: 'paragraph', html: 'Jämför flera oberoende körningar och ändra bara en parameter åt gången. Då kan du skilja en geometrisk modelleffekt från en följd av den valda observatören. Formlerna bygger intuition, men tolkningen beror alltid på referenssystemet och startvillkoren.' },
    { type: 'paragraph', html: 'Spara varje parameter och jämför sedan resultatet med en ändring i taget för att förstå modellens antaganden.' },
    { type: 'paragraph', html: 'Använd samma inställningar för en reproducerbar jämförelse och ändra sedan en parameter i taget. Då blir det tydligare vad som följer av geometrin och vad som beror på det valda referenssystemet. Simuleringen är en pedagogisk modell och inte en fullständig beskrivning av ett observerat svart hål.' },
  ],
  faq,
  bibliography,
  howTo,
