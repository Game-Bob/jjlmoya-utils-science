...
export const content: ToolLocaleContent = {
  ...
  seo: [
    ...
    { type: 'paragraph', html: 'Questa sezione descrive più precisamente la geometria usata dalla simulazione. Il raggio di Schwarzschild cresce con la massa e, nella soluzione ideale di Schwarzschild, rappresenta una superficie di coordinate associata all\'orizzonte degli eventi. La sfera dei fotoni si trova più lontano e corrisponde a orbite circolari instabili: una piccola perturbazione può cambiare rapidamente il destino della luce. La dilatazione temporale mostrata dipende dall\'osservatore scelto e non va confusa con il tempo proprio di un orologio locale. Cambiando prima la massa e poi la distanza puoi confrontare le scale senza confondere i loro effetti. Il modello non include rotazione, carica elettrica, materia circostante, disco di accrescimento, campi magnetici, radiazione o forze mareali di un oggetto specifico. Serve a costruire intuizione sulla relatività generale e a distinguere una definizione matematica da un\'osservazione astronomica. Per una sorgente reale occorrerebbero dati su massa, rotazione, ambiente e traiettoria, oltre a un confronto con una metodologia pubblicata. La pagina non offre previsioni operative né istruzioni per avvicinarsi a un oggetto compatto. Confronta le variabili separatamente e annota le ipotesi prima di interpretare i risultati.' },
    { type: 'paragraph', html: 'Puoi anche modificare la posizione dell\'osservatore e confrontare come cambia la visualizzazione del tempo. L\'esempio aiuta a distinguere una rappresentazione coordinata dalla misura di un orologio locale. In un oggetto reale, rotazione e materia circostante influenzano i percorsi della luce e il segnale osservato; un semplice modello sferico non descrive quindi tutte le osservazioni. Annota ogni parametro e ripeti il calcolo nelle stesse condizioni per capire origine e limiti del risultato.' },
    { type: 'paragraph', html: 'Confronta più esecuzioni indipendenti e modifica un solo parametro alla volta. In questo modo puoi distinguere un effetto geometrico del modello da una conseguenza della scelta dell\'osservatore. Le formule mostrate sono utili per l\'intuizione, ma la loro interpretazione dipende sempre dal sistema di riferimento e dalle ipotesi iniziali.' },
  ],
  faq,
  bibliography,
  howTo,
